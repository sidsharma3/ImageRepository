...
const SubmissionUpdateAdmin = ({ router }) => {
    ...
    const updateSubmissionForm = () => {
        return (
            <form onSubmit={editSubmission}>
                ...
                <div>
                    {fileDownloadLink && <a className="btn ml-2 btn-warning" href={fileDownloadLink}>Download Attachments!</a>}
                    <button type="submit" className="btn ml-2 btn-primary">
                        Update
                    </button>
                </div>
            </form>
...
export default withRouter(SubmissionUpdateAdmin);