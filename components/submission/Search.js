...
const Search = () => {
    ...
    const searchedSubmissions = (results = []) => {
        return (
        ...
        <form onSubmit={searchSubmit}>
            <div className="row">
                <div className="col-md-8">
                    <input type="search" className="form-control" placeholder="Search Submissions" onChange={handleChange} />
                </div>
    ...
    return (
        <div className="container-fluid">
            ...
            {searched && <div style={{ marginTop: '-120px', marginBottom: '-80px' }}>{searchedSubmissions(results)}</div>}
        </div>
    );
};
