...
const UserProfile = ({ user, submissions, query }) => {
    const head = () => (
        <Head>
            ...
            <meta name="description" content={`Submissions by ${user.username}`} />
            <meta property="og:title" content={`${user.username}| ${APP_NAME}`} />
            <meta property="og:description" content={`Submissions by ${user.username}`} />
